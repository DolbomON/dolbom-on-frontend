...
type WorkerReportQuickActionsProps = {
  onAiSummaryClick: () => void
  onWeeklyReportClick: () => void
}

export function WorkerReportQuickActions({
  onAiSummaryClick,
  onWeeklyReportClick,
}: WorkerReportQuickActionsProps) {
  return (
    <section aria-labelledby="worker-report-quick-actions-title">
      <h2
        id="worker-report-quick-actions-title"
