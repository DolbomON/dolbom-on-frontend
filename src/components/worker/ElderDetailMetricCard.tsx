...
import type { ElderMetric } from '../../features/worker/workerElderDetailData'
import { cn } from '../../lib/utils'

const metricIcons: Record<ElderMetric['id'], LucideIcon> = {
  aiSummary: Brain,
  riskSignal: TriangleAlert,
  todayRecord: ClipboardCheck,
}
...
type ElderDetailMetricCardProps = {
  metric: ElderMetric
}

export function ElderDetailMetricCard({ metric }: ElderDetailMetricCardProps) {
  ...
  return (
    <article
      className={cn(
        'flex min-h-[112px] min-w-0 flex-col items-center justify-center rounded-[20px] border px-2.5 py-3 text-center shadow-[0_10px_22px_rgba(40,91,172,0.08)] min-[410px]:min-h-[96px] min-[410px]:flex-row min-[410px]:gap-2.5 min-[410px]:text-left',
        tone.card,
      )}
