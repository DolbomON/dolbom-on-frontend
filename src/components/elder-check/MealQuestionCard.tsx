...
import { ElderProgress } from './ElderProgress'
...
export function MealQuestionCard({
  ...
  return (
    <section className="mt-8 rounded-[32px] border border-[#e7f1ff] bg-[radial-gradient(circle_at_52%_31%,rgba(255,255,255,0.96)_0_24%,transparent_52%),linear-gradient(180deg,#f2f8ff_0%,#eaf5ff_100%)] px-5 pb-7 pt-6 text-center shadow-[0_22px_48px_rgba(46,83,135,0.13),inset_0_1px_0_rgba(255,255,255,0.85)] min-[390px]:px-7 min-[390px]:pb-8 min-[390px]:pt-7">
      <ElderProgress currentStep={2} totalSteps={5} variant="stacked" />

      <div className="-mx-5 mt-8 min-[390px]:-mx-7 min-[390px]:mt-9">
        <img
