              ...
              {housingOptions.map((option) => {
                ...
                return (
                  <button
                    key={option.value}
                    className={cn(
                      'min-h-[58px] rounded-[999px] border-2 px-3 font-black shadow-[0_10px_18px_rgba(23,48,85,0.09)] transition active:scale-[0.985] focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-[#8bbcff] min-[390px]:min-h-[64px]',
                      selected
                        ? 'border-[#0876ff] bg-gradient-to-br from-[#147cff] to-[#0066f5] text-white shadow-[0_16px_28px_rgba(2,92,221,0.24)]'
