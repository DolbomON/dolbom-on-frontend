...
export function ElderMedicationCheckPage() {
  ...
  const [frequency, setFrequency] = useState<MedicationFrequency>('twice')
  const [selectedTimes, setSelectedTimes] = useState<MedicationTime[]>([
    'morning',
    'evening',
  ])
  const [assistance, setAssistance] = useState<MedicationHelp>('self')
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    navigate('/elder/check/meal', { state: { medicationHabit } })
  }
