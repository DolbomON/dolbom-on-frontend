      ...
      >
        ...
        <section className="mt-10 min-[390px]:mt-12">
          ...
          <h1
            ...
            aria-label={t('login.heading.aria')}
          >
            {t('login.heading.line1')}
            <br />
            <span className="text-[#0b63df]">{t('login.heading.accent')}</span>
            <br />
            {t('login.heading.line3')}
          </h1>
