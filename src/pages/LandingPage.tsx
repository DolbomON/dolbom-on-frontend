...
type HomeFeatureTranslationItem = Omit<
  HomeFeatureItem,
  'description' | 'title'
> & {
...
const featureItems: HomeFeatureTranslationItem[] = [
  {
    descriptionKey: 'landing.feature.medication.description',
    imageSrc: '/assets/dolbomon/home/icon-medication.png',
    target: '/elder/check',
    titleKey: 'landing.feature.medication.title',
  },
  {
    descriptionKey: 'landing.feature.chat.description',
    imageSrc: '/assets/dolbomon/home/icon-ai-chat.png',
    target: '/elder/chat',
    titleKey: 'landing.feature.chat.title',
  },
  {
    descriptionKey: 'landing.feature.alert.description',
    imageSrc: '/assets/dolbomon/home/icon-family-alert.png',
    target: '/family',
    titleKey: 'landing.feature.alert.title',
  },
]
