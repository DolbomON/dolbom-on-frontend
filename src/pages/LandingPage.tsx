    ...
    <main className="min-h-svh overflow-x-hidden bg-[#edf5ff] text-[#061844]">
      ...
      >
        ...
        >
          ...
          <ol
            className="mt-10 flex items-center justify-center gap-1 min-[430px]:gap-3.5"
            aria-label="오늘 기록 단계"
          >
            {[1, 2, 3, 4, 5].map((step) => (
              <li
                key={step}
                className="flex items-center gap-1 min-[430px]:gap-3"
              >
                <span
                  className={
                    step === 1
                ...
                {step < 5 ? (
                  <span
                    className="h-0.5 w-4 rounded-full border-t-2 border-dashed border-[#bfc8d5] min-[430px]:w-6"
                    aria-hidden="true"
                  />
                ) : null}
              </li>
